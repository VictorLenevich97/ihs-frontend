...
import { useGetSafetyQuery } from 'store/safety';
...
export const SafetyTable = ({ isSubcategories = true }: Props) => {
  ...
  const { data, isLoading, isError } = useGetSafetyQuery({
    page,
    showBy,
    searchString,
  ...
  const tableHeadTitles = [
    ...
    { id: 'fileSize', value: 'Размер файла', isSort: false },
    { id: 'documentLink', value: 'Скачать / Посмотреть', isSort: false },
  ];
